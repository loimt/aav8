...
public class CustomerIndayAdapter extends RecyclerView.Adapter<CustomerIndayAdapter.ViewHolder> {

    public CustomerIndayAdapter(Context context, ArrayList<CustomerItem> data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.customer_in_day_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CustomerIndayAdapter.ViewHolder holder, int position) {
