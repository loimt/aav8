...
public class UrlRequestCallback extends UrlRequest.Callback {
    ...
    public UrlRequestCallback(OnFinishRequest<JSONObject> onFinishRequest) {
    ...
    private String createHeaders(Map<String, List<String>> headers) {
        ...
        SharedPreferences authPreferences = ApplicationService.getAppContext().getSharedPreferences("AuthPreferences", Context.MODE_PRIVATE);
